        ...
        <div class="max-w-screen-lg mx-auto p-5 sm:p-10 md:p-16">
                ...
                <div class="mb-10 rounded overflow-hidden flex flex-col mx-auto">
                        ...
                        <p class="text-gray-700 py-5 text-lg leading-8">
                                Machu Picchu is a 15th-century Inca citadel situated on a mountain ridge 2,430 metres (7,970 ft)
                                above sea
                                level. It is located in the Cusco Region, Urubamba Province, Machupicchu District in Peru, above
                                the Sacred
                                Valley, which is 80 kilometres (50 mi) northwest of Cuzco and through which the Urubamba River
                                flows.
                        </p>
                </div>
